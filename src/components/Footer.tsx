export default function Footer() {
  ...
  return (
    <footer className="bg-stone-500 p-4 dark:bg-gray-800 sm:p-6">
      <div className="mx-auto max-w-screen-md lg:max-w-screen-xl">
        <div className="my-6 flex flex-col md:flex md:justify-between lg:flex-row">
          <div className="mt-0 md:mb-0">
            ...
            >
              <span className="text-shadow-header self-center whitespace-nowrap px-2 font-display text-2xl font-semibold text-secondary-100 lg:text-2xl">
                Happy 💯 Birthday
              </span>
            </a>
          </div>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-400 dark:text-gray-400 sm:text-center">
            <a href="#" className="block hover:underline">
              Made With ❤️ By Amie © {currentYear}
            </a>
          </span>
